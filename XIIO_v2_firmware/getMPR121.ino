...
//filtered data from all keys - for aftertouch etc
  ...
  platesFilteredData[8] = cap.filteredData(8);
  platesFilteredData[9] = cap.filteredData(7);
  platesFilteredData[10] = cap.filteredData(5);
  platesFilteredData[11] = cap.filteredData(3);
  ...
  platesFilteredData[0] = cap.filteredData(6);
  platesFilteredData[1] = cap.filteredData(9);
  platesFilteredData[2] = cap.filteredData(1);
  platesFilteredData[3] = cap.filteredData(2);
